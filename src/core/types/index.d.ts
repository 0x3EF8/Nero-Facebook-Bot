...
declare module "nero-core" {
    ...
    export interface API {
        ...
        /**
         * Manually refresh the DTSG token to prevent session expiration (error 1357004)
         * This is automatically called periodically, but can be triggered manually if needed
         * @returns Promise<boolean> - Whether the refresh was successful
         */
        refreshDtsg(): Promise<boolean>;

        /**
         * Start automatic DTSG token refresh
         * @param intervalMs - Custom interval in milliseconds (default: 1 hour)
         * @returns Function to stop the auto-refresh
         */
        startDtsgAutoRefresh(intervalMs?: number): () => void;

        /**
         * Stop automatic DTSG token refresh
         */
        stopDtsgAutoRefresh(): void;
