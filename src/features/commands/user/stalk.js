 ...
 * ╔═══════════════════════════════════════════════════════════════════════════════╗
 * ║                            STALK COMMAND                                      ║
 * ║         Get detailed information about a Facebook user                        ║
 * ╚═══════════════════════════════════════════════════════════════════════════════╝
 *
 * This command retrieves detailed information about a Facebook user
 * including profile picture and cover photo.
 *
 * @author 0x3EF8
 * @version 1.0.0
 */
...
module.exports = {
    config: {
        ...
        description:
            "Get detailed information about a Facebook user including profile picture and cover photo",
