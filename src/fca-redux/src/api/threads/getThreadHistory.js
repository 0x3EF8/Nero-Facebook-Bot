            ...
            case "UserMessage": {
                ...
                if (d.message?.ranges) {
                    d.message.ranges.forEach((e) => {
                        mentions[e.entity.id] = d.message.text.substring(
                            e.offset,
                            e.offset + e.length
                        );
                    });
                ...
                return {
                    ...
                    attachments: d.sticker
                        ...
                        : (d.blob_attachments || [])
                              .map(formatAttachmentsGraphQLResponse)
                              .concat(
            ...
            case "GenericAdminTextMessage": {
                ...
                return {
                    ...
                    logMessageType: utils.getAdminTextMessageType(
                        d.extensible_message_admin_text_type || d.__typename
                    ),
...
module.exports = function (defaultFuncs, api, ctx) {
    ...
    return async function getThreadHistory(threadID, amount, timestamp) {
        ...
        try {
            ...
            if (
                parsedData.error ||
                (Array.isArray(parsedData) && parsedData[parsedData.length - 1].error_results !== 0)
            ) {
                throw parsedData;
            }
            ...
            if (
                ...
                !parsedData[0] ||
                !parsedData[0].o0 ||
                !parsedData[0].o0.data
            ) {
                throw {
                    error: "getThreadHistory: Malformed response from GraphQL.",
                    res: parsedData,
                };
            }
