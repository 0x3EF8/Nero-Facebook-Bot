 ...
 */
module.exports.execute = async function({ api, event, args, logger, commandHandler }) {
    ...
    const eventDirs = [
        ...
        path.join(__dirname, "..", "..", "events", "otherEvents")
    ];
    ...
    // Not found anywhere
    return api.sendMessage(
        `❌ "${name}" not found as command or event.`,
        threadID,
        messageID
    );
};
